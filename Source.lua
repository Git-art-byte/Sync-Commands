--[[
	...
	Updated to fix Maximize button color consistency
]]
	...
	for _, button in pairs(Sidebar.Top.Buttons:GetChildren()) do
		if button:IsA("TextButton") then
			...
			elseif button.Name == "Maximize" then
				...
				-- Force refresh with tween to ensure color applies
				Tween(button, 0.1, { BackgroundColor3 = Color3.fromRGB(39, 201, 63), BackgroundTransparency = 0 })
			end
		end
	end
