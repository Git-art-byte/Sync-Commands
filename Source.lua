--[[
	...
	Updated to ensure window control buttons retain colors
]]
	...
	Names = {
		...
		["Close"] = function(Button)
			if Button:IsA("TextButton") then
				...
				print("Themes.Names.Close: Applied color: " .. tostring(Button.BackgroundColor3)) -- Debug
			end
		end,
		...
		["Minimize"] = function(Button)
			if Button:IsA("TextButton") then
				...
				Button.BackgroundTransparency = 0
				print("Themes.Names.Minimize: Applied color: " .. tostring(Button.BackgroundColor3)) -- Debug
			end
		end,
		...
		["Maximize"] = function(Button)
			if Button:IsA("TextButton") then
				...
				Button.BackgroundTransparency = 0
				print("Themes.Names.Maximize: Applied color: " .. tostring(Button.BackgroundColor3)) -- Debug
			end
		end,
		...
		["TextButton"] = function(Label)
			...
			if Label.Name == "Close" or Label.Name == "Minimize" or Label.Name == "Maximize" then
				...
				if Label.Name == "Close" then
					...
					print("TextButton class: Applied Close color: " .. tostring(Label.BackgroundColor3)) -- Debug
				elseif Label.Name == "Minimize" then
					Label.BackgroundColor3 = Color3.fromRGB(255, 189, 68) -- Yellow
					Label.BackgroundTransparency = 0
					print("TextButton class: Applied Minimize color: " .. tostring(Label.BackgroundColor3)) -- Debug
				elseif Label.Name == "Maximize" then
					Label.BackgroundColor3 = Color3.fromRGB(39, 201, 63) -- Green
					Label.BackgroundTransparency = 0
					print("TextButton class: Applied Maximize color: " .. tostring(Label.BackgroundColor3)) -- Debug
				end
...
function Library:CreateWindow(Settings: { Title: string, Size: UDim2, Transparency: number, MinimizeKeybind: Enum.KeyCode?, Blurring: boolean, Theme: string })
	...
	-- Explicitly set window control button colors on initialization
	for _, button in pairs(Sidebar.Top.Buttons:GetChildren()) do
		if button:IsA("TextButton") then
			if button.Name == "Close" then
				...
				print("CreateWindow: Initialized Close button color: " .. tostring(button.BackgroundColor3)) -- Debug
			elseif button.Name == "Minimize" then
				SetProperty(button, {
					BackgroundColor3 = Color3.fromRGB(255, 189, 68), -- Yellow
					BackgroundTransparency = 0
				})
				print("CreateWindow: Initialized Minimize button color: " .. tostring(button.BackgroundColor3)) -- Debug
			elseif button.Name == "Maximize" then
				SetProperty(button, {
					BackgroundColor3 = Color3.fromRGB(39, 201, 63), -- Green
					BackgroundTransparency = 0
				})
				print("CreateWindow: Initialized Maximize button color: " .. tostring(button.BackgroundColor3)) -- Debug
			end
		end
	end
	...
	function Options:SetTheme(themeInfo)
		...
		-- Explicitly reapply window control button colors after theme application
		for _, button in pairs(Sidebar.Top.Buttons:GetChildren()) do
			if button:IsA("TextButton") then
				if button.Name == "Close" then
					SetProperty(button, {
					...
					print("SetTheme: Reapplied Close button color: " .. tostring(button.BackgroundColor3)) -- Debug
				elseif button.Name == "Minimize" then
					SetProperty(button, {
						BackgroundColor3 = Color3.fromRGB(255, 189, 68), -- Yellow
						BackgroundTransparency = 0
					})
					print("SetTheme: Reapplied Minimize button color: " .. tostring(button.BackgroundColor3)) -- Debug
				elseif button.Name == "Maximize" then
					SetProperty(button, {
						BackgroundColor3 = Color3.fromRGB(39, 201, 63), -- Green
						BackgroundTransparency = 0
					})
					print("SetTheme: Reapplied Maximize button color: " .. tostring(button.BackgroundColor3)) -- Debug
				end
			end
		end

		-- Force UI refresh to ensure colors are applied in exploit environments
		Window.Visible = false
