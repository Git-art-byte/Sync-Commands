	...
	Names = {
		...
		["Close"] = function(Button)
			if Button:IsA("TextButton") then
				...
				print("Applied Close button color: " .. tostring(Button.BackgroundColor3)) -- Debug
			end
		end,
		...
		["Minimize"] = function(Button)
			if Button:IsA("TextButton") then
				...
				print("Applied Minimize button color: " .. tostring(Button.BackgroundColor3)) -- Debug
			end
		end,
		...
		["Maximize"] = function(Button)
			if Button:IsA("TextButton") then
				...
				print("Applied Maximize button color: " .. tostring(Button.BackgroundColor3)) -- Debug
			end
		end,
	...
	function Options:SetTheme(themeInfo)
		...
		for Index, Descendant in next, Screen:GetDescendants() do
			...
			if Name then
				Name(Descendant)
			elseif Class then
				-- Apply class-based themes (TextButton handled in Themes.Classes)
				Class(Descendant)
			end
		end
